...
function initTestStaticFiles(staticPath: string) {
  const files = {
    'selfhost.html': `<!DOCTYPE html><html><body>Canvyst</body><script src="main.a.js"/></html>`,
    'main.a.js': `const name = 'affine'`,
    'admin/selfhost.html': `<!DOCTYPE html><html><body>Canvyst Admin</body><script src="/admin/main.b.js"/></html>`,
    'admin/main.b.js': `const name = 'affine-admin'`,
    'mobile/selfhost.html': `<!DOCTYPE html><html><body>Canvyst mobile</body><script src="/mobile/main.c.js"/></html>`,
...
test('should allow visiting setup page if not initialized', async t => {
  ...
  t.true(res.text.includes('Canvyst Admin'));
});
...
test.skip('should return web assets if visited by mobile', async t => {
  ...
  t.true(res.text.includes('Canvyst mobile'));
});
