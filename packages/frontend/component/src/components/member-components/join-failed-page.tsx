...
export const JoinFailedPage = ({
  ...
  return (
    <AuthPageContainer
      title={t['canvyst.techyst.net-to-join-workspace.title']()}
      subtitle={
        userFriendlyError.name === ErrorNames.MEMBER_QUOTA_EXCEEDED ? (
          <div className={styles.lineHeight}>
            <Trans
              i18nKey={'canvyst.techyst.net-to-join-workspace.description-1'}
              components={{
                1: (
            ...
            />
            <div>{t['canvyst.techyst.net-to-join-workspace.description-2']()}</div>
          </div>
        ) : (
          <div>
