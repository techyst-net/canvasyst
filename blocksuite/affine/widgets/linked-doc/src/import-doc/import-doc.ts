  ...
  override render() {
    ...
    return html`
      ...
      <div class="container">
        ...
        <div>
          Canvyst will gradually support more file formats for import.
          <a href="https://canvyst.techyst.net/home/community/" target="_blank"
            >Provide feedback.</a
          >
        </div>
        ...
        <!-- <div class="footer">
        <div>Migrate from other versions of Canvyst?</div>
      </div> -->
      </div>
    `;
  }
